...
public class TaskingCzmlTypeHandlerTest
{
	@Autowired
	private TaskingCzmlTypeHandler taskingCzmlTypeHandler;

	@Test
	public void testCanHandle() {
		Assert.assertTrue(taskingCzmlTypeHandler.canHandle(TaskingModel.class));
	}

	@Test
	public void testCanHandleFalse() {
		Assert.assertFalse(taskingCzmlTypeHandler.canHandle(String.class));
	}

	@Test
	public void testHandlesIterable() {
		Assert.assertFalse(taskingCzmlTypeHandler.handlesIterable());
	}
	...
	public void testHandle() {
		...
		final List<String> czmlList = taskingCzmlTypeHandler.handle(taskingModel);
