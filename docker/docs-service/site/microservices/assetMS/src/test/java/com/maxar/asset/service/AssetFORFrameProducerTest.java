...
public class AssetFORFrameProducerTest
{
	private Asset asset;
	...
	public void testGetFOR() {
		final AssetFORFrameProducer assetFORFrameProducer = new AssetFORFrameProducer(
				asset);
		...
		final GeodeticGeometry forGeometry = assetFORFrameProducer.getFOR(atTime);
	...
	public void testGetName() {
		...
		Assert.assertEquals("WV01",
							assetFORFrameProducer.getName());
	}
	...
	public void testGetSensorType() {
		...
		Assert.assertEquals("",
							assetFORFrameProducer.getSensorType());
	}
}
