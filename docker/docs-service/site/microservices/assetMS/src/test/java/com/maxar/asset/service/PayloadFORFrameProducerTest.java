...
public class PayloadFORFrameProducerTest
{
	private Asset asset;
	...
	public void testGetFOR() {
		final PayloadFORFrameProducer payloadFORFrameProducer = new PayloadFORFrameProducer(
				asset.getPayloads()
						.get(1));
		...
		final GeodeticGeometry forGeometry = payloadFORFrameProducer.getFOR(atTime);

		Assert.assertNull(forGeometry);
	}
	...
	public void testGetName() {
		...
		Assert.assertEquals("WV01_Payload",
							payloadFORFrameProducer.getName());
	}
	...
	public void testGetSensorType() {
		...
		Assert.assertEquals("Payload",
							payloadFORFrameProducer.getSensorType());
	}
}
