...
public class WeatherFileIngesterTestRtneph
{
	private static final String WEATHER_PROPERTIES_FILE = "testweatherdm.properties";

	private static final String WEATHER_XML_BEANS_FILE = "testweatherrtneph.xml";
	...
	private RTNEPHQuarterGridWeatherParser parser;
	...
	public void setUp()
		...
		parser = Mockito.mock(RTNEPHQuarterGridWeatherParser.class);
	}
	...
	public void testBeanLoaded() {
		...
		Assert.assertNull(weatherFileIngester.getWeatherSetRepository());
	}
