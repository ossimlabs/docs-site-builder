package com.maxar.asset.common.client.airborne;
...
@Component
public class AssetRetrieverAirborne extends
		AssetRetrieverAbstract
{
	@Autowired
	private RestTemplate restTemplate;

	@Value("${microservices.asset.airborne.getAssetIdByName}")
	private String getAssetIdByNameUrl;

	@Value("${microservices.asset.airborne.getAssetModelXmlById}")
	private String getAssetModelXmlByIdUrl;

	@Value("${microservices.asset.airborne.getAllAssetExtraDataNames}")
	private String getAllAssetExtraDataNamesUrl;

	@Value("${microservices.asset.airborne.getAssetExtraDataByName}")
